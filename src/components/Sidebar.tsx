    ...
    <>
      ...
      >
        <div className="flex flex-col h-full relative">
          {/* Logo/Brand */}
          <div className={cn("p-6 border-b flex items-center justify-between min-h-[97px]", sidebarCollapsed ? "px-4 justify-center" : "")}>
            {!sidebarCollapsed && (
            ...
            <div className={cn("flex items-center gap-3", sidebarCollapsed ? "justify-center" : "")}>
              ...
              {!sidebarCollapsed && (
                <div className="flex-1 min-w-0 animate-in fade-in slide-in-from-left-2 duration-300">
                  <p className="text-sm font-semibold truncate text-slate-900">{user?.name || "Admin"}</p>
          ...
          <div className={cn("p-4 border-t", sidebarCollapsed ? "px-2" : "")}>
            <Button
              ...
              className={cn(
                ...
                sidebarCollapsed ? "justify-center px-0" : "justify-start px-3 text-slate-600 hover:text-red-600 hover:bg-red-50"
              )}
              onClick={logout}
            >
              <LogOut className={cn("h-5 w-5", !sidebarCollapsed ? "mr-3 text-slate-500 group-hover:text-red-600" : "text-slate-500 group-hover:text-red-600")} />
